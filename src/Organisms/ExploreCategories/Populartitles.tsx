        ...
        <React.Fragment>
            ...
            <Grid container>
                ...
                <Grid item>
                    ...
                    <Grid item style={{marginTop:'28px'}}>
                    <Category categoryname="Creativity" sx={{':hover': {color:'#0365F2',backgroundColor:'#F1F6F4'}}} icon={ <SchoolOutlinedIcon /> } />
                    </Grid>

                    <Grid item style={{marginTop:'28px'}}>
                    <Category categoryname="Mindfulness & Happiness" sx={{':hover': {color:'#0365F2',backgroundColor:'#F1F6F4'}}} icon={ <SchoolOutlinedIcon /> } />
                    </Grid>

                    <Grid item style={{marginTop:'28px'}}>
                    <Category categoryname="Philosophy" sx={{':hover': {color:'#0365F2',backgroundColor:'#F1F6F4'}}} icon={ <SchoolOutlinedIcon /> } />
                    </Grid>
