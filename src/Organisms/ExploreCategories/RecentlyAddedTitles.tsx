        ...
        <React.Fragment>
            ...
            <Grid container>
                ...
                <Grid item>
                    ...
                    <Grid item style={{marginTop:'28px'}}>
                    <Category categoryname="Management & Leadership" sx={{':hover': {color:'#0365F2',backgroundColor:'#F1F6F4'}}} icon={ <TrackChangesOutlinedIcon /> } />
                    </Grid>

                    <Grid item style={{marginTop:'28px'}}>
                    <Category categoryname="Society & Culture" sx={{':hover': {color:'#0365F2',backgroundColor:'#F1F6F4'}}} icon={ <TrackChangesOutlinedIcon /> } />
                    </Grid>

                    <Grid item style={{marginTop:'28px'}}>
                    <Category categoryname="Technology & The future" sx={{':hover': {color:'#0365F2',backgroundColor:'#F1F6F4'}}} icon={ <TrackChangesOutlinedIcon /> } />
                    </Grid>
