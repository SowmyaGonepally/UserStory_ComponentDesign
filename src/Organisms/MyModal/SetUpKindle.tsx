    ...
    <ThemeProvider theme={Theme}>
      ...
      >
        <Box sx={style}>
          ...
          <br></br>
          <MyButton buttonName="Add email" variant="contained" className={classes.addemail} ></MyButton>
          <br></br><br></br>
          <MyButton buttonName="Need help?" variant='text' className={classes.addemail}></MyButton>
            </Box>
      </Modal>
    </ThemeProvider>
  );
